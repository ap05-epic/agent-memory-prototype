...
- [ ] W7 test hardening — **brief ready**: `docs/briefs/W7_TEST_HARDENING.md` (45 cases over the write gate, ranking maths, decision parsing, degradation paths and never-raise contracts — the logic that carries the most risk and had the least direct coverage)
