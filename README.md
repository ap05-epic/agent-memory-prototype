...
- [ ] W8 console tenant plumbing — **brief ready**: `docs/briefs/W8_CONSOLE_TENANT.md` (server-side tenant config → `user.tenant_id` on turns + memory proxy routes; the live gate is driving the browser, not curl). The last workstream.
