...
- [ ] W2 governed memory — **brief ready**: `docs/briefs/W2_GOVERNED_MEMORY.md` (list/delete/forget/disable endpoints, append-only audit table as revision 003, per-user opt-out checked at turn start, retention worker with a configured-only purge window, 7-case test slice)
