...
- [~] W2 governed memory — **built, one fix outstanding**: endpoints, audit table (revision `4f743f1f0d2d`, applied), per-user opt-out, retention worker, 12 targeted tests green. Routes need converting to `async def` — see KNOWN_ISSUES open item 1. Uncommitted on v3; brief: `docs/briefs/W2_GOVERNED_MEMORY.md`
